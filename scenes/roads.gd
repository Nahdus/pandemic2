...
export(Vector2) var map_size = Vector2.ONE * 100
...
#onready var obstacles = get_parent().get_node("buildings").get_used_cells_by_id(0)
onready var obstacles = get_parent().get_node("buildings").obstacles
